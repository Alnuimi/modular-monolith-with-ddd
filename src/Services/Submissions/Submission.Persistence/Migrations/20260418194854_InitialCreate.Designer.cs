...
namespace Submission.Persistence.Migrations
{
    ...
    [Migration("20260418194854_InitialCreate")]
            ...
            modelBuilder.Entity("Submission.Domain.Entities.Person", b =>
                {
                    ...
                    b.ComplexProperty<Dictionary<string, object>>("EmailAddress", "Submission.Domain.Entities.Person.EmailAddress#EmailAddress", b1 =>
                        {
                            b1.IsRequired();
